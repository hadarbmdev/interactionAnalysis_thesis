...
def loadCodesIntoDFAndCsv():
    ...
    global_utils.operateOnJsonObjAcrossAllJsonFiles(
...
def convertToFrequencyRatio(matrix_input, dir, outputDir):
    ...
    # print("matrix_input: ")
    # print(matrix_input)
    matrix_input.to_csv(outputDir + 'categoryFrequency.csv', index=False)
    print('file categoryFrequency.csv was written with calculated matrix')
    return matrix_input
...
def createFrequencyDf(jsonsDir):
    ...
    matrix_input = global_utils.operateOnJsonFilesForMatrix(addRowToDfPerFileWithOccurenceNumber, 'addRowToDfPerFileWithOccurenceNumber',
                                                            jsonsDir, countBehaviorToDataRow, matrix_input)
